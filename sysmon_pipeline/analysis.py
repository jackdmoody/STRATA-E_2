...
def compute_shap_importance(
    ...
    # MUST match the matrix the model was fit on (flag rates are excluded
    # from the frequency channel) — naming from the full rate_features frame
    # shifts every SHAP value onto the wrong feature name.
    from .scoring import freq_feature_frame
    X = freq_feature_frame(rate_features)
